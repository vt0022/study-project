import { Alert, Avatar, Box, Button, Checkbox, Container, FormControl, FormControlLabel, FormHelperText, IconButton, InputAdornment, InputLabel, Link, OutlinedInput, Snackbar, Stack, TextField, Typography } from "@mui/material";
...
function Login() {
    ...
    return (
        <>
            <Container>
                <Box
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                                            ...
                                            <OutlinedInput
                                                ...
                                                endAdornment={
                                                    <InputAdornment position="end">
                                                        <IconButton aria-label={showPassword ? "Hide password" : "Show password"} onClick={onClickShowPassword} onMouseDown={onMouseDownPassword} onMouseUp={onMouseUpPassword} edge="end">
                        ...
                        <Button variant="contained" fullWidth size="large" type="submit" loading={isSubmitting}>
                            Log in
                        </Button>
                    </form>
            ...
            <Snackbar anchorOrigin={{ vertical: "bottom", horizontal: "center" }} open={openNoti} autoHideDuration={2000} onClose={onCloseSnackbar}>
