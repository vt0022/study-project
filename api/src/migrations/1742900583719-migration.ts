...
export class Migration1742900583719 implements MigrationInterface {
    name = 'Migration1742900583719'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "code" ADD "expired_at" TIMESTAMP NOT NULL`);
