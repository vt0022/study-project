...
export class Migration1742900655400 implements MigrationInterface {
    name = 'Migration1742900655400'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "code" ADD "expired_at" TIMESTAMP NOT NULL DEFAULT NOW()`);
        await queryRunner.query(`ALTER TABLE "code" ADD "is_used" boolean NOT NULL DEFAULT false`);
        ...
        await queryRunner.query(`ALTER TABLE "post" ADD "is_private" boolean NOT NULL DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "post" ADD "image_url" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "post" ADD "thumbnail_url" character varying`);
        ...
        await queryRunner.query(`ALTER TABLE "follower" ADD "following_id" integer`);
        await queryRunner.query(`ALTER TABLE "user" ALTER COLUMN "last_name" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "follower" ADD CONSTRAINT "FK_d2c4468e1264a8169609be8ac59" FOREIGN KEY ("followed_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "follower" ADD CONSTRAINT "FK_07301dde24966bb953f6749780d" FOREIGN KEY ("following_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "follower" DROP CONSTRAINT "FK_07301dde24966bb953f6749780d"`);
        await queryRunner.query(`ALTER TABLE "follower" DROP CONSTRAINT "FK_d2c4468e1264a8169609be8ac59"`);
        await queryRunner.query(`ALTER TABLE "user" ALTER COLUMN "last_name" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "follower" DROP COLUMN "following_id"`);
        ...
        await queryRunner.query(`ALTER TABLE "post" ADD "thumbnailUrl" character varying`);
        await queryRunner.query(`ALTER TABLE "post" ADD "imageUrl" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "post" ADD "isPrivate" boolean NOT NULL DEFAULT false`);
        ...
        await queryRunner.query(`ALTER TABLE "code" ADD "expiredAt" TIMESTAMP NOT NULL`);
